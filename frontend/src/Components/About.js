    ...
    return (
        <div className="about-container">
            ...
            <div className="about-content">
                <h2>John Doe</h2>
                <p>
                    John Doe is the visionary behind our computer teaching institute. With over 20 years of experience in the tech industry, John has a deep passion for technology and education. He holds a Master's degree in Computer Science from a prestigious university and has worked with leading tech companies around the world.
                </p>
                <p>
